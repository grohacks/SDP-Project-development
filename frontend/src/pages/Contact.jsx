...
<p className="m-8 lg:mb-16 font-light text-center text__para">
  Got a technical issue? Want to send feedback about a beta feature? Let us know. 
</p><form action="#" className="space-y-8">
<div>
...
<div className="sm:col-span-2">
  ...
  <textarea 
  rows='6'
  type="text" id="message" placeholder="Leave a commment.. " className="form__input mt-1"/>
</div>
