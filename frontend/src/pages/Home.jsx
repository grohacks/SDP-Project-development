...
<div>
    ...
    <div className="lg:w-[570px]">
        <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">We help patients live a healthy, longer life.
             ...
             <p className="text__para"> Welcome to our hospital booking website. Quickly find and book appointments with top doctors, access your medical records, and manage your health effortlessly. Our platform ensures a seamless, secure, and user-friendly experience, connecting you to quality healthcare at your convenience. </p>
...
<p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
    An skilled an expertized talentic doctors ,in seek of your goodwell
...
<p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
    Click on our goto pointer to know about our location
...
<p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
    Synchronize your appointment witb our well care and curated platform and be the part of our growing and loving family 
...
<p className="text__para text-center">
    We are here to serve you and be in you and with you 
</p>
...
<div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
    ...
    <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor">Nishant Gurram</h4>
</div>
</div>
...
<p className="text__para text-center">
    A miracle preclaiming to cure any type of disease with much acquired skills, mechanism and methods 
</p>
