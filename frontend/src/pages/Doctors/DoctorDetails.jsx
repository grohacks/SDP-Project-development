            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-5">
                <figure className="max-w-[200px] max-h-[200px]">
                  <img src={photo || '/path/to/default/photo.jpg'} alt={name} className="w-full" />
                </figure>
                <div>
