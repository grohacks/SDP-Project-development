...
{error && !loading && <Error errMessage={error}/>}
   ...
   {!loading && !error &&  <div className="grid md:grid-cols-3 gap-10">
    ...
    <p className="text-textColor text-[15px] leading-6 font-medium">Blood Type: <span className="ml-2 text-headingColor text-[22px] leading-8">{userData.bloodType}</span>
    </p>
    </div>
